...
int main() {
    for (int i = 0; i < 2; i++) {
        string corlabelName = colorSort();
        if (corlabelName != "") {
            if (corlabelName == "pink") {
                cout << "corlabelName::pink " << endl;
            }
            else if (corlabelName == "white")
            {
                cout << "corlabelName::white " << endl;
            }
            else if (corlabelName == "mid")
            {
                cout << "corlabelName::mid "<<endl;
            }
